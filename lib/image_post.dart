import 'package:Fluttergram/post_form.dart';
...
class _ImagePost extends State<ImagePost> {
  ...
  buildPostHeader({String ownerId, WhyFarther selection}) {
    if (ownerId == null) {
                ...
                itemBuilder: (BuildContext context) => <PopupMenuEntry<WhyFarther>>[
                   PopupMenuItem<WhyFarther>(
                    ...
                    child: FlatButton(onPressed: (){
                      ...
                      color: Colors.red, child: Text("Delete", style: TextStyle(color: Colors.white),),),
                  ),
                   PopupMenuItem<WhyFarther>(
                    value: WhyFarther.smarter,
                    child:  FlatButton(onPressed:(){;},color: Colors.green, child: Text("Edit", style: TextStyle(color: Colors.white),),),
                  ),
...
class ImagePostFromId extends StatefulWidget {
  final String id;

  const ImagePostFromId({this.id});

  @override
  _ImagePostFromIdState createState() => _ImagePostFromIdState();
}

class _ImagePostFromIdState extends State<ImagePostFromId> {

  getImagePost() async {
    var document =
        await Firestore.instance.collection('insta_posts').document(widget.id).get();
